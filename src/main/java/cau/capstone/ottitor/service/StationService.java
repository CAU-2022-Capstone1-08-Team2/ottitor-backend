...
public class StationService {
    ...
    private final List<String> lineNumList = List.of("01호선");
...
//        }
        ...
        try {
            ...
            while ((line = file.readLine()) != null) {
                ...
                Station station =  Station.builder().code(rows.get(0)).nmKor(rows.get(1)).nmEng(rows.get(2)).lineNum(rows.get(3)).frCode(rows.get(4)).mnt(Integer.parseInt(rows.size() > 5 ? rows.get(5) : "0")).build();
